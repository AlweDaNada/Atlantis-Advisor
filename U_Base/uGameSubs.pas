...
var
  ...
  function HasMonsters(ARegion: DataStructs.TRegion): boolean;
  ...
  function CanProduce(U: TUnit; R: DataStructs.TRegion; IData: TItemData;
    var Level, Amount: integer): integer;
  function ProduceOut(U: TUnit; R: DataStructs.TRegion; IData: TItemData; var MaxOut,
  ...
  function RegionInDir(Coords: TCoords; Dir: integer): DataStructs.TRegion;
...
function MakeRegionName(C: TCoords; UseSettlement: boolean): string;
var Region: DataStructs.TRegion;
begin
...
function RoadExists(Region: DataStructs.TRegion; From: TCoords): boolean;
var i: integer;
begin
  Result := False;
...
function MovableDir(From: TCoords; Dir: integer; Sail: boolean; MT: integer; CanSwim: boolean; Ship: TStruct): boolean;
var Region, RegInDir: DataStructs.TRegion;
    C: TCoords;
begin
  Result := False;
