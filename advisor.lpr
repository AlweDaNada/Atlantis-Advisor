...
uses
  Forms, LCLProc, FileCtrl, CalcForm, LazUtils, lazcontrols, CheckBoxThemed,
  LazControlDsgn, RichMemo, ComponentEditors, IDEExternToolIntf,
  BGRAGraphics, Win32RichMemo, Interfaces, Main {MainForm},
  ...
  uMiniMap in 'uMiniMap.pas', CylinderMap,
